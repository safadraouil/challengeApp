...
import { addUsers, updateUsers } from "./Reducer";
...
function Fileindex() {
  ...
  const handelOnSubmit = (name, option, term) => {
    const user = { name, option, term };
    dispatch(addUsers(user));
  };
  const handelOnUpdate = (name, option, term) => {
    const user = { name, option, term };
    dispatch(updateUsers(user));
  };
  return (
    <div>
      <div className="formsCard" name="form" id="form">
        <div className="card">
          <p>
          ...
          <div className="term">
            <input
              ...
              data-candidate-id={selectedTerm}
              value={selectedTerm}
              onChange={() => setSelectedTerm(!selectedTerm)}
            />{" "}
            <p>Agree to terms</p>
          </div>
          <br />
          ...
          <div className="buttons">
            <input
              ...
              id="submit"
              onClick={() =>
                handelOnSubmit(selectedName, selectedOption, selectedTerm)
              }
            />
            <input
              type="button"
              ...
              id="submit"
              onClick={() =>
                handelOnUpdate(selectedName, selectedOption, selectedTerm)
              }
            />
          </div>
        </div>
